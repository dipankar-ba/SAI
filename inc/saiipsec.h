...
typedef enum _sai_ipsec_sa_attr_t
{
    ...
    /**
     * @brief Enable 64-bit ESN (vs 32-bit PN) for this Security Association
     *
     * @type bool
     * @flags CREATE_ONLY
     * @default true
     ...
     * @flags MANDATORY_ON_CREATE | CREATE_ONLY
     */
    SAI_IPSEC_SA_ATTR_MACSEC_SAK,

    /** @ignore - proper name for IPsec encryption key */
    SAI_IPSEC_SA_ATTR_ENCRYPTION_KEY = SAI_IPSEC_SA_ATTR_MACSEC_SAK,
     ...
     * @flags MANDATORY_ON_CREATE | CREATE_ONLY
     */
    SAI_IPSEC_SA_ATTR_MACSEC_AUTH_KEY,

    /** @ignore - proper name for IPsec authentication key */
    SAI_IPSEC_SA_ATTR_AUTH_KEY = SAI_IPSEC_SA_ATTR_MACSEC_AUTH_KEY,
